...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bleumintcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bleumintcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bleumintcoin transaction") + "\n" +
              "  bleumintcoin-tx [options] -create [commands]   " + _("Create hex-encoded bleumintcoin transaction") + "\n" +
              "\n";
