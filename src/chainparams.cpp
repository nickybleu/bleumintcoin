...
{
    const char* pszTimestamp = "Nicky: We are launching our bleumintcoin today, 31st Jan 2022";
    const CScript genesisOutputScript = CScript() << ParseHex("160584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1643623935, 2001437786, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc8e9e678a89369991cc5a9c51de80cd8c80efb39964e065330d44665e70d0eae"));
        assert(genesis.hashMerkleRoot == uint256S("0x7ee925d356bc60c389d12da58470841e6a7cb4d8a5a35de370beba37cb5e74b2"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("65.108.167.31", "65.108.167.31", true));
		//vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("bleumintcointools.com", "dnsseed.bleumintcointools.com"));
        //vSeeds.push_back(CDNSSeedData("bleumintcoinpool.org", "dnsseed.bleumintcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xc8e9e678a89369991cc5a9c51de80cd8c80efb39964e065330d44665e70d0eae"))
        ...
        chainTxData = ChainTxData{
            ...
            1643623935, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1643623935, 656787, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb2165b5173bc35003d023d6adcb30306a536b80a1297fad3a7c3f8fdc7ade994"));
        assert(genesis.hashMerkleRoot == uint256S("0x7ee925d356bc60c389d12da58470841e6a7cb4d8a5a35de370beba37cb5e74b2"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("65.108.167.31", "65.108.167.31"));
		// vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bleumintcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xb2165b5173bc35003d023d6adcb30306a536b80a1297fad3a7c3f8fdc7ade994")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1643623935, 5, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x89832cdf502f387c3440da5ff14ff457ab8e1f87fa179de1b9ab37fb81d64bf9"));
        assert(genesis.hashMerkleRoot == uint256S("0x7ee925d356bc60c389d12da58470841e6a7cb4d8a5a35de370beba37cb5e74b2"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x89832cdf502f387c3440da5ff14ff457ab8e1f87fa179de1b9ab37fb81d64bf9"))
        };
