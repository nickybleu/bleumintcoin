...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bleumintcoin-project/bleumintcoin>";
    const std::string URL_WEBSITE = "<https://bleumintcoin.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Bleumintcoin version %s\n", FormatFullVersion());
}
